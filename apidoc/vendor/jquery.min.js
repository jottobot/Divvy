...
!function(a,b){
  ...
  var c=[],d=a.document,e=c.slice,f=c.concat,g=c.push,h=c.indexOf,i={},j=i.toString,k=i.hasOwnProperty,l={},m='2.2.1',n=function(a,b){
    ...
    if(!L(a)){
      return{};
    }var b=a[this.expando];return b||(b={},L(a)&&(a.nodeType?a[this.expando]=b:Object.defineProperty(a,this.expando,{value:b,configurable:!0}))),b;
  },set:function(a,b,c){
    ...
    if(a[n.expando]){
      return a;
    }var b,c,e,f=a.type,g=a,h=this.fixHooks[f];h||(this.fixHooks[f]=h=ea.test(f)?this.mouseHooks:da.test(f)?this.keyHooks:{}),e=h.props?this.props.concat(h.props):this.props,a=new n.Event(g),b=e.length;while(b--){
      c=e[b],a[c]=g[c];
    ...
    b=f.apply([],b);var e,g,h,i,j,k,m=0,o=a.length,p=o-1,q=b[0],r=n.isFunction(q);if(r||o>1&&'string'===typeof q&&!l.checkClone&&ma.test(q)){
    ...
    var d,e,f,g,h=a.cloneNode(!0),i=n.contains(a.ownerDocument,a);if(!(l.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||n.isXMLDoc(a))){
  ...
  }var Ha=/^(none|table(?!-c[ea]).+)/,Ia={position:'absolute',visibility:'hidden',display:'block'},Ja={letterSpacing:'0',fontWeight:'400'},Ka=['Webkit','O','Moz','ms'],La=d.createElement('div').style;function Ma(a){
    if(a in La){
      return a;
    }var b=a[0].toUpperCase()+a.slice(1),c=Ka.length;while(c--){
      if(a=Ka[c]+b,a in La){
        return a;
      }
    }
  ...
  },_default:'swing'},n.fx=Ra.prototype.init,n.fx.step={};var Sa,Ta,Ua=/^(?:toggle|show|hide)$/,Va=/queueHooks$/;function Wa(){
    ...
    var d,e,f,g,h,i,j,k,l=this,m={},o=a.style,p=a.nodeType&&V(a),q=N.get(a,'fxshow');c.queue||(h=n._queueHooks(a,'fx'),null==h.unqueued&&(h.unqueued=0,i=h.empty.fire,h.empty.fire=function(){
      h.unqueued||i();
    ...
    var d=function(a){
      ...
      var b=!0,e=null!=a&&a+'queueHooks',f=n.timers,g=N.get(this);if(e){
        g[e]&&g[e].stop&&d(g[e]);
      }else {
        for(e in g){
    ...
    return a!==!1&&(a=a||'fx'),this.each(function(){
      var b,c=N.get(this),d=c[a+'queue'],e=c[a+'queueHooks'],f=n.timers,g=d?d.length:0;for(c.finish=!0,n.queue(this,a,[]),e&&e.stop&&e.stop.call(this,!0),b=f.length;b--;){
    ...
    var a,b=0,c=n.timers;for(Sa=n.now();b<c.length;b++){
  ...
  }();var ab,bb=n.expr.attrHandle;n.fn.extend({attr:function(a,b){
  ...
  });var cb=/^(?:input|select|textarea|button)$/i,db=/^(?:a|area)$/i;n.fn.extend({prop:function(a,b){
  ...
  });var ib=a.location,jb=n.now(),kb=/\?/;n.parseJSON=function(a){
    return JSON.parse(a+'');
    ...
    'object'===typeof b&&(c=b,b=void 0),c=c||{};var e,f,g,h,i,j,k,l,m=n.ajaxSetup({},c),o=m.context||m,p=m.context&&(o.nodeType||o.jquery)?n(o):n.event,q=n.Deferred(),r=n.Callbacks('once memory'),s=m.statusCode||{},t={},u={},v=0,w='canceled',x={readyState:0,getResponseHeader:function(a){
      ...
      return x.abort();
    }w='abort';for(l in{success:1,error:1,complete:1}){
      x[l](m[l]);
    }if(e=wb(sb,m,c,x)){
  ...
  };var Gb={0:200,1223:204},Hb=n.ajaxSettings.xhr();l.cors=!!Hb&&'withCredentials'in Hb,l.ajax=Hb=!!Hb,n.ajaxTransport(function(b){
    ...
    if(!a||'string'!==typeof a){
      return null;
    }'boolean'===typeof b&&(c=b,b=!1),b=b||(l.createHTMLDocument?d.implementation.createHTMLDocument(''):d);var e=x.exec(a),f=!c&&[];return e?[b.createElement(e[1])]:(e=ca([a],b,f),f&&f.length&&n(f).remove(),n.merge([],e.childNodes));
  };var Kb=n.fn.load;n.fn.load=function(a,b,c){
    if('string'!==typeof a&&Kb){
      return Kb.apply(this,arguments);
    }var d,e,f,g=this,h=a.indexOf(' ');return h>-1&&(d=n.trim(a.slice(h)),a=a.slice(0,h)),n.isFunction(b)?(c=b,b=void 0):b&&'object'===typeof b&&(e='POST'),g.length>0&&n.ajax({url:a,type:e||'GET',dataType:'html',data:b}).done(function(a){
    ...
    return n;
  });var Mb=a.jQuery,Nb=a.$;return n.noConflict=function(b){
