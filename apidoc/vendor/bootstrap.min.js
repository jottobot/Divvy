...
if('undefined'===typeof jQuery){
  ...
  'use strict';function b(b){
    ...
    c&&3===c.which||(a(e).remove(),a(f).each(function(){
      var d=a(this),e=b(d),f={relatedTarget:this};e.hasClass('open')&&(c&&'click'==c.type&&/input|textarea/i.test(c.target.tagName)&&a.contains(e[0],c.target)||(e.trigger(c=a.Event('hide.bs.dropdown',f)),c.isDefaultPrevented()||(d.attr('aria-expanded','false'),e.removeClass('open').trigger(a.Event('hidden.bs.dropdown',f)))));
    }));
  }function d(b){
    return this.each(function(){
  ...
  'use strict';function b(b){
    ...
    }var h=null==this.affixed,i=h?e:f.top,j=h?g:b;return null!=c&&e<=c?'top':null!=d&&i+j>=a-d&&'bottom';
