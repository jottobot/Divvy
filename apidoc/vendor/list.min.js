...
!function a(b,c,d){
    ...
    if(!c[g]){
      if(!b[g]){
        var i='function'===typeof require&&require;if(!h&&i){
          ...
          return f(g,!0);
        }var j=new Error('Cannot find module \''+g+'\'');throw j.code='MODULE_NOT_FOUND',j;
  ...
  !function(c,d){
    'use strict';var e=c.document,f=a('./src/utils/get-by-class'),g=a('./src/utils/extend'),h=a('./src/utils/index-of'),i=a('./src/utils/events'),j=a('./src/utils/to-string'),k=a('./src/utils/natural-sort'),l=a('./src/utils/classes'),m=a('./src/utils/get-attribute'),n=a('./src/utils/to-array'),o=function(b,c,p){
      var q,r=this,s=a('./src/item')(r),t=a('./src/add-async')(r);q={start:function(){
        ...
        for(var a=0;a<r.plugins.length;a++){
          var b=r.plugins[a];r[b.name]=b,b.init(r,o);
        }
        ...
        if(0!==a.length){
          if(b){
            return void t(a,b);
          }var c=[],e=!1;a[0]===d&&(a=[a]);for(var f=0,g=a.length;f<g;f++){
            var h=null;e=r.items.length>r.page,h=new s(a[f],d,e),r.items.push(h),c.push(h);
          }return r.update(),c;
        }
        ...
        for(var c=[],d=0,e=r.items.length;d<e;d++){
          var f=r.items[d];f.values()[a]==b&&c.push(f);
        }return c;
      },this.size=function(){
        ...
        var c=r.handlers[a],d=h(c,b);return d>-1&&c.splice(d,1),r;
        ...
        var a=r.items,b=a.length;r.visibleItems=[],r.matchingItems=[],r.templater.clear();for(var c=0;c<b;c++){
  ...
  b.exports=function(a){
    var b=function(c,d,e){
      var f=c.splice(0,50);e=e||[],e=e.concat(a.add(f)),c.length>0?setTimeout(function(){
        b(c,d,e);
      },1):(a.update(),d(e));
    };return b;
  };
  ...
  b.exports=function(a){
    return a.handlers.filterStart=a.handlers.filterStart||[],a.handlers.filterComplete=a.handlers.filterComplete||[],function(b){
      if(a.trigger('filterStart'),a.i=1,a.reset.filter(),void 0===b){
        ...
        a.filtered=!0;for(var c=a.items,d=0,e=c.length;d<e;d++){
          var f=c[d];b(f)?f.filtered=!0:f.filtered=!1;
        }
  ...
  b.exports=function(b){
    var c=a('./item')(b),d=function(a){
        ...
        var d=a.splice(0,50);e(d,c),a.length>0?setTimeout(function(){
          f(a,c);
        },1):(b.update(),b.trigger('parseComplete'));
      };return b.handlers.parseComplete=b.handlers.parseComplete||[],function(){
      var a=d(b.list),c=b.valueNames;b.indexAsync?f(a,c):e(a,c);
    };
  };
  ...
  b.exports=function(a){
    var b,c,d,e,f={resetList:function(){
        ...
        a.found=!1;for(var b=0,d=c.length;b<d;b++){
      ...
      var c=b.target||b.srcElement,d=''===c.value&&!a.searched;d||h(c.value);
    }),a.utils.events.bind(a.utils.getByClass(a.listContainer,a.searchClass),'input',function(a){
      var b=a.target||a.srcElement;''===b.value&&h('');
    }),h;
  };
},{}],7:[function(a,b,c){
  b.exports=function(a){
    a.sortFunction=a.sortFunction||function(b,c,d){
      return d.desc='desc'==d.order,a.utils.naturalSort(b.values()[d.valueName],c.values()[d.valueName],d);
        ...
        var c=a.utils.getAttribute(b,'data-order');return'asc'==c||'desc'==c?c:a.utils.classes(b).has('desc')?'asc':a.utils.classes(b).has('asc')?'desc':'asc';
      },getInSensitive:function(b,c){
        var d=a.utils.getAttribute(b,'data-insensitive');'false'===d?c.insensitive=!1:c.insensitive=!0;
      },setOrder:function(c){
        for(var d=0,e=b.els.length;d<e;d++){
          var f=b.els[d];if(a.utils.getAttribute(f,'data-sort')===c.valueName){
            var g=a.utils.getAttribute(f,'data-order');'asc'==g||'desc'==g?g==c.order&&a.utils.classes(f).add(c.order):a.utils.classes(f).add(c.order);
          }
        }
      }},c=function(){
        a.trigger('sortStart');var c={},d=arguments[0].currentTarget||arguments[0].srcElement||void 0;d?(c.valueName=a.utils.getAttribute(d,'data-sort'),b.getInSensitive(d,c),c.order=b.getOrder(d)):(c=arguments[1]||c,c.valueName=arguments[0],c.order=c.order||'asc',c.insensitive='undefined'===typeof c.insensitive||c.insensitive),b.clear(),b.setOrder(c),c.sortFunction=c.sortFunction||a.sortFunction,a.items.sort(function(a,b){
          var d='desc'===c.order?-1:1;return c.sortFunction(a,b,c)*d;
  ...
  var d=function(a){
    var b,c=this,d=function(){
      ...
      if(void 0===b){
        ...
        if(/<tr[\s>]/g.exec(b)){
          var f=document.createElement('tbody');return f.innerHTML=b,f.firstChild;
        }if(b.indexOf('<')!==-1){
          var g=document.createElement('div');return g.innerHTML=b,g.firstChild;
        }var h=document.getElementById(a.item);if(h){
          return h;
        }
      }
    },this.get=function(b,d){
      c.create(b);for(var e={},f=0,g=d.length;f<g;f++){
        var h;if(d[f].data){
      ...
      var e=function(b){
          ...
          var f,g=e(c);g&&(g.data?b.elm.setAttribute('data-'+g.data,d):g.attr&&g.name?(f=a.utils.getByClass(b.elm,g.name,!0),f&&f.setAttribute(g.attr,d)):(f=a.utils.getByClass(b.elm,g,!0),f&&(f.innerHTML=d)),f=void 0);
        };if(!c.create(b)){
        for(var g in d){
      ...
      }var d=b.cloneNode(!0);return d.removeAttribute('id'),a.elm=d,c.set(a,a.values()),!0;
  ...
  function d(a){
  ...
  }var e=a('./index-of'),f=/\s+/,g=Object.prototype.toString;b.exports=function(a){
    return new d(a);
  },d.prototype.add=function(a){
    if(this.list){
      return this.list.add(a),this;
    }var b=this.array(),c=e(b,a);return~c||b.push(a),this.el.className=b.join(' '),this;
  },d.prototype.remove=function(a){
    if('[object RegExp]'==g.call(a)){
      return this.removeMatching(a);
    }if(this.list){
      return this.list.remove(a),this;
    }var b=this.array(),c=e(b,a);return~c&&b.splice(c,1),this.el.className=b.join(' '),this;
    ...
    var a=this.el.getAttribute('class')||'',b=a.replace(/^\s+|\s+$/g,''),c=b.split(f);return''===c[0]&&c.shift(),c;
  ...
  var d=window.addEventListener?'addEventListener':'attachEvent',e=window.removeEventListener?'removeEventListener':'detachEvent',f='addEventListener'!==d?'on':'',g=a('./to-array');c.bind=function(a,b,c,e){
    a=g(a);for(var h=0;h<a.length;h++){
      a[h][d](f+b,c,e||!1);
    }
  ...
  b.exports=function(a,b){
    var c=a.getAttribute&&a.getAttribute(b)||null;if(!c){
  ...
  b.exports=function(){
    return document.getElementsByClassName?function(a,b,c){
      ...
      var d=[],e='*';null===a&&(a=document);for(var f=a.getElementsByTagName(e),g=f.length,h=new RegExp('(^|\\s)'+b+'(\\s|$)'),i=0,j=0;i<g;i++){
  ...
  b.exports=function(a,b,c){
    var d,e,f=/(^([+\-]?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?(?=\D|\s|$))|^0x[\da-fA-F]+$|\d+)/g,g=/^\s+|\s+$/g,h=/\s+/g,i=/(^([\w ]+,?[\w ]+)?[\w ]+,?[\w ]+\d+:\d+(:\d+)?[\w ]?|^\d{1,4}[\/\-]\d{1,4}[\/\-]\d{1,4}|^\w+, \w+ \d+, \d{4})/,j=/^0x[0-9a-f]+$/i,k=/^0/,l=c||{},m=function(a){
        return(l.insensitive&&(''+a).toLowerCase()||''+a).replace(g,'');
      },n=m(a),o=m(b),p=n.replace(f,'\0$1\0').replace(/\0$/,'').replace(/^\0/,'').split('\0'),q=o.replace(f,'\0$1\0').replace(/\0$/,'').replace(/^\0/,'').split('\0'),r=parseInt(n.match(j),16)||1!==p.length&&Date.parse(n),s=parseInt(o.match(j),16)||r&&o.match(i)&&Date.parse(o)||null,t=function(a,b){
      ...
      if(d=t(p[u]||'',v),e=t(q[u]||'',w),isNaN(d)!==isNaN(e)){
        ...
        var y=d.localeCompare(e);return y/Math.abs(y);
      }if(d<e){
        return-1;
      }if(d>e){
        return 1;
